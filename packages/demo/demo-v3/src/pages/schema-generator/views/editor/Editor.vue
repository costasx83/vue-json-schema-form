<template>
    <div style="position: relative;">
        ...
        <EditorHeaderVT v-model="activeHeaderTab">
            <v-btn @click="handleImportSchema">Import Schema</v-btn>
            <v-btn
                plain
                @click="handleToDemo"
            >
        ...
        <div :class="[$style.container]">
            ...
            >
                ...
                <div :class="[$style.contentBox]">
                    ...
                    >
                        <h2>Item count {{ componentList.length }}</h2>
                        <NestedEditor
                            :child-component-list="componentList"
                            :drag-options="dragOptions"
                            :form-data="rootFormData"
                            :form-props="formProps"
                            @update:child-component-list="componentList = $event"
                        >
                            <v-col
                            ...
                            >
                                <v-btn @click="$emit('onCancel')">{{ formFooter.cancelBtn }}</v-btn>
                                <v-btn
                                    type="primary"
                                    @click="$emit('onSubmit')"
                                >
                ...
                <div :class="$style.rightForm">
                    ...
                    >
                        ...
                        <v-tab value="formConfig">Form Config</v-tab>
                    </v-tabs>
...
<script>
import { h } from 'vue';
import VueJsonFrom from '@lljj/vue3-form-vuetify';
...
export default {
    ...
    data() {
        return {
            ...
            activeHeaderTab: 'schema-generator'
        };
    },
                            ...
                            if (errorNode.length > 0 && Array.isArray(errorNode)) {
                                return this.$msgbox({
                                    ...
                                    message: h(
                                        ...
                                        errorNode.map(item => h('pre', null, JSON.stringify(item, null, 4)))
                                    )
                                });
                            }
